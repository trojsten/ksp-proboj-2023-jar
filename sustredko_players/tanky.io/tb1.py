...
class LepsiPlayer(ProbojPlayer):
    ...
    upgrades = [StatsEnum.StatSpeed, StatsEnum.StatSpeed, StatsEnum.StatBulletTTL, StatsEnum.StatRange, 
                StatsEnum.StatHealthRegeneration, StatsEnum.StatHealthMax, StatsEnum.StatBulletDamage]
    entities_map = {}
    turn = 0
