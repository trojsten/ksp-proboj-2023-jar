...
class LepsiPlayer(ProbojPlayer):
    def make_turn(self) -> Turn:
        ...
        staka = random.choice((StatsEnum.StatSpeed,StatsEnum.StatRange,StatsEnum.StatRange,StatsEnum.StatBulletDamage, StatsEnum.StatBulletTTL, StatsEnum.StatHealthMax,StatsEnum.StatHealthRegeneration,StatsEnum.StatReloadSpeed))
