...
poradieupgr = [0,StatsEnum.StatSpeed,StatsEnum.StatSpeed,StatsEnum.StatBulletDamage,StatsEnum.StatRange,
               ...
               StatsEnum.StatHealthRegeneration,StatsEnum.StatHealthRegeneration,StatsEnum.StatRange,StatsEnum.StatSpeed,
               StatsEnum.StatHealthMax,StatsEnum.StatHealthMax,StatsEnum.StatSpeed,StatsEnum.StatSpeed,
               ...
               StatsEnum.StatHealthRegeneration,StatsEnum.StatHealthMax,StatsEnum.StatHealthMax,StatsEnum.StatSpeed,
               StatsEnum.StatRange,StatsEnum.StatRange,StatsEnum.StatHealthMax,
               StatsEnum.StatBodyDamage,StatsEnum.StatBodyDamage,StatsEnum.StatBodyDamage,
...
class LepsiPlayer(ProbojPlayer):
    ...
    def make_turn(self) -> Turn:
        ...
        global lastlevel,lastlives,tik
        ...
        if self.myself.tank.tank_id != 10:
            ...
            if self.myself.position.distance(nearest) < 75:
                ...
                if self.myself.reload_cooldown == 0:
                    ...
                    alpha = self.myself.position.angle_to(nearest)+math.pi/3
            ...
            if self.myself.position.distance(nearest) < 50:
                ...
                if self.myself.position.distance(nearest) < 300:
                    if self.myself.health < maxzakladhealth:
                        dodge = 1.9
                    else:
                        dodge = 4
                else:
