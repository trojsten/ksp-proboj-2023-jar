...
class OurPlayer(ProbojPlayer):
    ...
    def make_turn(self) -> Turn:
        ...
        if direction.x == inf and direction.y == inf:
            ...
            # Moving away from border
                ...
                if self.myself.position.distance(predicted) > bullet_distance - BULLET_DISTANCE_TOLLERANCE:
                    ...
                    direction = self.myself.position + (nearest_player - self.previous_position)
        ...
        stat_list += [StatsEnum.StatHealthMax, StatsEnum.StatHealthRegeneration, StatsEnum.StatReloadSpeed]
        random_stat_list = [StatsEnum.StatReloadSpeed, StatsEnum.StatSpeed, StatsEnum.StatBulletSpeed, StatsEnum.StatBulletTTL,
                            StatsEnum.StatBulletDamage, StatsEnum.StatHealthMax, StatsEnum.StatHealthRegeneration]
        ...
        if sum_ < len(stat_list):
            ...
            stat = random.choice(random_stat_list)

        tank1 = SniperTank
        tank2 = WideBulletTank
